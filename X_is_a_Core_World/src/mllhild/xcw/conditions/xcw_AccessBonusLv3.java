...
public class xcw_AccessBonusLv3 extends BaseMarketConditionPlugin{
    public static float ACCESSIBILITY_MOD = 0.30f;
    @Override
    public void apply(String id) {
        this.market.getAccessibilityMod().modifyFlat(id, ACCESSIBILITY_MOD, "X Core Access Bonus Lv 3");
    }
